...
class User{
    protected:
        ...
        string name;
    public:
        User(string n1, string n2) : username(n1), name(n2) {}
...
class Influencer : public Blogger{
    protected:
        int count;
    public:
        Influencer(string userUsername,string userName) : Blogger(userUsername, userName) {
            count = 0;
        }
        ...
        void manageFollowers(){
            ...
            cin >> count;
            displayProfile();
            cout << "Follower Count: " << count << endl;
        }
};
