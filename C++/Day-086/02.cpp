...
class P{
    protected:
        ...
        double current;
    public:
    P(double a, double b) : voltage(a), current(b){}
};
...
class PE : public P{
    protected:
        double efficiency;
    public:
        PE(double a, double b, double c) : P(a,b), efficiency(c){}
        ...
        void UsefulPower(){
            cout << "Useful Output Power: " << fixed << setprecision(1) << power() * efficiency << "W" <<endl;
        }
        
        void WastefulPower(){
            cout << "Wasted Power: " << fixed << setprecision(1) << power() * (1-efficiency) << "W" <<endl;
        }
        
        void display(){
            cout <<"Power: " << fixed << setprecision(1) << power() << "W" <<endl;
            UsefulPower();
            WastefulPower();
        }
};
