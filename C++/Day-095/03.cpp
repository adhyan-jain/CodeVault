...
class HighwayDriver{
    ...
    double times;
    public:
        HighwayDriver(double a, double b, double c) : distance(a), times(b+c/60){
            cout << fixed << setprecision(2) << distance / times << " mph" << endl;
        }
        
        HighwayDriver(double a, double b) : distance(a), times(b){
            cout << fixed << setprecision(2) << distance / times << " mph" << endl;
        }
};
...
int main(){
    ...
    HighwayDriver h1(a, b, c);
    HighwayDriver h2(d, e);
    return 0;
}
