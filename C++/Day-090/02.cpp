...
class RentEligibility : public Tenant{
    double percent;
    public:
        RentEligibility(double a, double b) : Tenant(a), percent(b){}
        ...
        void calc(){
            if (get() < 15000) {
                ...
                cout << "Eligible" << endl;
                cout << "Rent Amount: " << fixed << setprecision(2) << percent * get() / 100 << endl;
        }
};
