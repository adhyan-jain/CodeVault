...
class Account{
    ...
    float balance;
    public:
        Account(string s, float a) : acc_num(s), balance(a){}
        
        void deposit(float a){
            balance += a;
            cout << "Deposited " << fixed << setprecision(2) << a << " successfully." << endl;
        }
        
        void withdraw(float a){
            balance -= a;
            cout << "Withdrawn " << fixed << setprecision(2) << a << " successfully." << endl;
        }
...
class SavingsAccount : public Account{
    float rate;
    public:
        SavingsAccount(string s, float a, float b) : Account(s, a), rate(b) {}
        ...
        void display(){
            float inter = calcInterest();
            cout << "Interest added: " << fixed << setprecision(2) << inter << endl;
            cout << "Savings Account Balance: " << fixed << setprecision(2) << addInterest() << endl;
        }
};
