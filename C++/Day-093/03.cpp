...
class Language{
    protected:
        int population;
    public:
        Language(int a) : population(a){}
};

class English : public Language{
    int englishSpeakers;
    public:
        English(int a, int b): Language(a), englishSpeakers(b){}
        
        void EnglishPercentStatus(){
            double n = static_cast<double>(englishSpeakers) / population * 100;
            cout << "English Percentage: " << fixed << setprecision(1) << n << "%" << endl;
...
class Spanish : public Language{
    int spanishSpeakers;
    public:
        Spanish(int a, int b): Language(a), spanishSpeakers(b){}
        
        void SpanishPercentStatus(){
            double n = static_cast<double>(spanishSpeakers) / population * 100;
            cout << "Spanish Percentage: " << fixed << setprecision(1) << n << "%" << endl;
...
int main(){
    ...
    e.EnglishPercentStatus();
    s.SpanishPercentStatus();
    return 0;
}