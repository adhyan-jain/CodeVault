...
Anu is planning to travel to various countries for work and leisure. She wants to determine the priority of learning the local language based on specific criteria for each country. Write a program to assist Anu in making informed decisions about language learning priorities using switch statement.

The following are the conditions for language learning priority:

For France (Country Code 1):
1.	If the English-speaking population is below 50%, prioritize learning the local language (Priority: High). 
2.	Otherwise, prioritize other languages (Priority: Low).

For Japan (Country Code 2):
1.	If the average life expectancy is above 80 years, prioritize learning the local language (Priority: High). 
2.	Otherwise, prioritize other languages (Priority: Low).

For Brazil (Country Code 3):
1.	If the percentage of the urban population is above 80%, prioritize learning the local language (Priority: High). 
2.	Otherwise, prioritize other languages (Priority: Low).
